...
class NeumorphismLoginForm {
    ...
    validateEmail() {
        ...
        if (!email) {
            this.showError('email', 'Eᴍᴀɪʟ Iꜱ RᴇQᴜɪʀᴇᴅ');
            return false;
        }
        
        if (!emailRegex.test(email)) {
            this.showError('email', 'Pʟᴇᴀꜱᴇ Eɴᴛᴇʀ A Vᴀʟɪᴅ Eᴍᴀɪʟ');
            return false;
        }
    ...
    validatePassword() {
        ...
        if (!password) {
            this.showError('password', 'Pᴀꜱꜱᴡᴏʀᴅ Iꜱ RᴇQᴜɪʀᴇᴅ');
            return false;
        }
        
        if (password.length < 6) {
            this.showError('password', 'Pᴀꜱꜱᴡᴏʀᴅ Mᴜꜱᴛ Bᴇ Aᴛ Lᴇᴀꜱᴛ 6 Cʜᴀʀᴀᴄᴛᴇʀꜱ');
            return false;
        }
    ...
    async handleSubmit(e) {
        ...
        try {
            ...
            this.showError('password', 'Lᴏɢɪɴ Fᴀɪʟᴇᴅ');
        } finally {
